...
<!-- Hero Section -->
        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-text fade-in">
                    ...
                    <h1>ETX — A Stable Digital Asset Built for Smart Trading</h1>
    ...
    <section class="trading-section">
        <div class="container">
            <div class="trading-header fade-in">
            ...
            <div class="trading-container">
                <div class="chart-container fade-in">
                    <div class="chart-header">
                        <div class="pair-info">
                            <div class="pair-name">ETX/USDT</div>
                            <div class="pair-price" id="mainPrice">$1.0002</div>
                            <div class="pair-change" id="mainChange">+0.02%</div>
                        </div>
                        <div style="color: #999; font-size: 14px;">
                            <i class="fas fa-circle pulse" style="color: #00FF9D; font-size: 10px;"></i> Live
                        </div>
                    </div>
                ...
                <div class="order-sidebar">
                    <div class="order-book fade-in">
                        <div class="order-book-header">
                            <div>Order Book</div>
                            <div>ETX/USDT</div>
                        </div>
                        <div class="order-list" id="orderBook">
                            <!-- Order book will be populated by JavaScript -->
                        </div>
                    </div>
                    
                    <div class="recent-trades fade-in">
                        <div class="order-book-header">
                            <div>Recent Trades</div>
                            <div>ETX/USDT</div>
                        </div>
                        <div class="order-list" id="recentTrades">
